...
import 'page_system.dart'; // นำเข้าไฟล์ PageSystem
import 'sign_up_page.dart'; // นำเข้าไฟล์ SignUpPage
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      if (account != null) {
        ...
        // เปลี่ยนหน้าไปที่ PageSystem หลังจากล็อกอินสำเร็จ
        Navigator.pushReplacement(
          // ignore: use_build_context_synchronously
          context,
          MaterialPageRoute(builder: (context) => const PageSystem()), // นำทางไปที่หน้า PageSystem
        );
      }
    } catch (error) {
